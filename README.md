...
Specify input dataset path in [Macrovascular-Complications-inputs.yml](Macrovascular-Complications-inputs.yml).

## Usage

Run: `cwltool Macrovascular-Complications.cwl Macrovascular-Complications-inputs.yml`
