...
(async () => {
  ...
  await fs.writeFile("macrovascular-complications-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("macrovascular-complications-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
